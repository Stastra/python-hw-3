""" Створіть функцію def double_zero(array) яка приймає цілочисельний масив і дублює 
всі нулі, повертаючи новий массив в якому нулі продубльювані, при дублювані всі інші 
елементи повинні бути зсунутті вправо.
...
print(double_zero([1,0,2,3,0,4,5,0])) # [1,0,0,2,3,0,0,4,5,0,0]
print(double_zero([1,0,0,2,3,0,4,5,0])) # [1,0,0,2,3,0,0,4,5,0,0]
print(double_zero([1,2,3]))           # [1,2,3]